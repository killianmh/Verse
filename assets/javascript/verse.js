    ...
    functions : {
        ...
        getRapSentence : function() {
            ...
            $.ajax({
                ...
                var randomSentenceQueryURL = "https://api.wordnik.com:80/v4/word.json/"+ word + "/examples?includeDuplicates=false&useCanonical=false&skip=0&limit="+maxSentences+"&api_key=a2a73e7b926c924fad7001ca3111acd55af2ffabf50eb4ae5"
